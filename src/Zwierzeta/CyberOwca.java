...
import Rosliny.BarszczSosnowskiego;
...
public class CyberOwca extends Zwierze {
    ...
    protected void akcja() {
        List<Organizm> barszczeSosnowskiego = swiat.organizmy.stream()
                .filter(organizm -> organizm.getClass() == BarszczSosnowskiego.class)
                .toList();
        ...
        Polozenie najblizszyBarszcz = barszczeSosnowskiego.stream()
